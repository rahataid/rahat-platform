export const EVENTS = {
  ...
  IMPORT_TEMP_BENEFICIARIES_FROM_CT: 'beneficiary.import_temp_beneficiaries_from_ct',
  IMPORT_TEMP_BENEFICIARIES_FROM_EXCEL: "beneficiary.import_temp_beneficiaries_from_excel",
};
