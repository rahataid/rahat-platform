...
export const aaActions: ProjectActionFunc = {
  ...
  [MS_ACTIONS.AAPROJECT.STAKEHOLDERS.GET_GROUP_DETAILS_BY_UUIDS]: (
    ...
    sendCommand(
      { cmd: AAJobs.STAKEHOLDERS.GET_GROUP_DETAILS_BY_UUIDS, uuid },
      payload
    ),
  ...
  [MS_ACTIONS.AAPROJECT.BENEFICIARY.GET_BALANCE]: (
    ...
    payload,
    sendCommand
  ) => sendCommand({ cmd: AAJobs.BENEFICIARY.GET_BALANCE, uuid }, payload),
  ...
  [MS_ACTIONS.AAPROJECT.INKIND.GET_ALL_STOCK_MOVEMENTS]: (
    ...
    sendCommand({ cmd: AAJobs.INKIND.GET_ALL_STOCK_MOVEMENTS, uuid }, payload),

  [MS_ACTIONS.AAPROJECT.INKIND.REMOVE_INKIND_STOCK]: (
    uuid,
    payload,
    sendCommand
  ...
  [MS_ACTIONS.AAPROJECT.INKIND.GET_UNASSIGNED_GROUP_INKIND]: (
    ...
    sendCommand(
      { cmd: AAJobs.INKIND.GET_UNASSIGNED_GROUP_INKIND, uuid },
      payload
    ),
  ...
  [MS_ACTIONS.AAPROJECT.INKIND.BENEFICIARY_INKIND_REDEEM]: (
    ...
    sendCommand(
      { cmd: AAJobs.INKIND.BENEFICIARY_INKIND_REDEEM, uuid },
      payload
    ),
  ...
  [MS_ACTIONS.AAPROJECT.INKIND.GET_GROUP_INKIND_LOGS_BY_VENDOR]: (
    ...
    sendCommand(
      { cmd: AAJobs.INKIND.GET_GROUP_INKIND_LOGS_BY_VENDOR, uuid },
      payload
    ),
  ...
  [MS_ACTIONS.AAPROJECT.INKIND.GET_LOGS_DETAILS_BY_VENDOR]: (
    ...
    sendCommand(
      { cmd: AAJobs.INKIND.GET_LOGS_DETAILS_BY_VENDOR, uuid },
      payload
    ),
  [MS_ACTIONS.AAPROJECT.INKIND.GET_LOGS_DETAILS_BY_TX_HASH]: (
    ...
    sendCommand(
      { cmd: AAJobs.INKIND.GET_LOGS_DETAILS_BY_TX_HASH, uuid },
      payload
    ),

  [MS_ACTIONS.AAPROJECT.INKIND.SEND_BENEFICIARY_OTP]: (
    uuid,
    payload,
    sendCommand
  ) => sendCommand({ cmd: AAJobs.INKIND.SEND_BENEFICIARY_OTP, uuid }, payload),

  [MS_ACTIONS.AAPROJECT.INKIND.VALIDATE_BENEFICIARY_OTP]: (
    uuid,
    payload,
    sendCommand
  ) =>
  ...
  [MS_ACTIONS.AAPROJECT.MULTISIG.GET_SAFE_OWNER]: (
    ...
    payload,
    sendCommand
  ) => sendCommand({ cmd: AAJobs.MULTISIG.GET_SAFE_OWNER, uuid }, payload),
